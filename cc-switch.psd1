@{
    ...
    FunctionsToExport = @('Use-ClaudeProfile','Show-CcStatus','New-CcProfile','Remove-CcProfile','Invoke-CcSwitch','Get-CcProfiles','Get-CcAccountEmail','Set-CcAlias','Remove-CcAlias','Register-CcAliases','ccx')
